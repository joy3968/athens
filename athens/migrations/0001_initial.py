# Generated by Django 3.1.3 on 2020-11-06 05:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.customer_tbl')),
                ('l_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.lecture_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='test_tbl',
            fields=[
                ...
                ('tr_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='online_tbl',
        ...
        migrations.AddField(
            ...
            name='t_no',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.teacher_tbl'),
        ),
        migrations.CreateModel(
            name='consult_tbl',
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.customer_tbl')),
                ('t_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='athens.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='attendance_tbl',
