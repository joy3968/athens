...
class customer_tbl(models.Model):
    ...
    c_gender = models.CharField(max_length=10,choices=(('남성','남성'),('여성','여성')))
...
class teacher_tbl(models.Model):
    ...
    t_gender = models.CharField(max_length=10,choices=(('남성','남성'),('여성','여성')))
    ...
    t_file = models.ImageField(null=True,blank=True, upload_to='teacher/')
...
class online_tbl(models.Model):
    ...
    on_file = models.FileField(upload_to='online/',blank=True)
